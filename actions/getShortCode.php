 ...
 * **************************************************************************
 *
 * File:         getShortCode.php
 *
 * Purpose:      Holds the functionality for [getShortCode] Text2Pay API action.
...
/**
 * Represents the action <b>getShortCode</b> executed in Text2Pay API.
 *
 ...
 *
 */
final class Text2PayApi_getShortCode_Request
extends Text2PayApi_RequestBase {
    ...
    public function __construct($apiConnection, $countryCode) {
        ...
        $this->setArgument('action',   	   'getShortCode');
     ...
     *
     * @return Text2PayApi_getShortCode_Response object
     *
     * @see Text2PayApi_RequestBase
    ...
    public function execute() {
        ...
        return new Text2PayApi_getShortCode_Response($response);
    }
}

/**
 * Represents the response for the action <b>getShortCode</b> executed
 * in Text2Pay API, with {@link Text2PayApi_getShortCode_Request}.
 *
 ...
 *
 * <ul>
 *  <li>{@link Text2PayApi_getShortCode_Response::getText()}
 * </ul>
 *
 * @see Text2PayApi_getShortCode_Request
 *
 * @author Braga, Bruno <bruno.braga@gmail.com>
 *
 * @since 0.3
 ...
 *
 */
final class Text2PayApi_getShortCode_Response
extends Text2PayApi_ResponseBase {

    /**
     * See main documentation in its getter method, defined as
     * {@link Text2PayApi_getShortCode_Response::getShortCode()}
     *
     * @var string
     *
     * @see Text2PayApi_getShortCode_Response
     * @see Text2PayApi_getShortCode_Response::getShortCode()
     *
     * @author Braga, Bruno <bruno.braga@gmail.com>
     *
     * @since 0.3
    ...
    /**
     * See main documentation in its getter method, defined as
     * {@link Text2PayApi_getShortCode_Response::getKeyword()}
     *
     * @var string
     *
     * @see Text2PayApi_getShortCode_Response
     * @see Text2PayApi_getShortCode_Response::keyword()
     *
     * @author Braga, Bruno <bruno.braga@gmail.com>
     *
     * @since 0.3
     ...
     * [short_code] XML node.
     *
     * @return int value of the short code
     *
     * @see Text2PayApi_getShortCode_Response
     *
     * @author Braga, Bruno <bruno.braga@gmail.com>
     ...
     * [keyword] XML node.
     *
     * @return int value of the keyword used with the short code.
     *
     * @see Text2PayApi_getShortCode_Response
     *
     * @author Braga, Bruno <bruno.braga@gmail.com>
